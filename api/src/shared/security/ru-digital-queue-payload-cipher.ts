...
const PURPOSE = 'ru-digital-queue-payload-v1';
let cachedKey: Buffer | undefined;

/**
 * Encrypts/decrypts data that travels through BullMQ job payloads (both
 * persisted in Redis in transit). Uses a subkey derived from
 * RUDIGITAL_CACHE_ENCRYPTION_KEY distinct from the one used for
