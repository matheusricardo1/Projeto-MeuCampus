...
Este projeto e independente da API: possui suas proprias dependencias, scripts e deploy. Nao ha workspace unificado nem pacote compartilhado de contratos.
